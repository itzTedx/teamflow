              ...
              <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
                <AnimatedGroup variants={transitionVariants}>
                  <Link
                    ...
                    href="#link"
                  >
                    <span className="text-foreground text-sm">Introducing Support for AI Features</span>
                ...
                <TextEffect
                  ...
                  speedSegment={0.3}
                >
                  AI-powered tools for team collaboration, productivity, and communication.
                </TextEffect>
                ...
                >
                  <div className="rounded-[calc(var(--radius-xl)+0.125rem)] border bg-foreground/10 p-0.5" key={1}>
                  ...
                  <Button asChild className="h-10.5 rounded-xl px-5" key={2} size="lg" variant="ghost">
                    <Link href="#link">
        ...
        <section className="bg-background pt-16 pb-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
              <Link className="block text-sm duration-150 hover:opacity-75" href="/">
