  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          className="relative size-12 rounded-xl border-border/50 bg-background/50 transition-all duration-200 hover:rounded-lg hover:bg-accent hover:text-accent-foreground"
          size="icon"
          variant="outline"
        >
          <Avatar className="relative size-full rounded-xl transition-all hover:rounded-lg">
            <Image alt="User avatar" fill src={getAvatar(user.email ?? "", user.picture)} />
